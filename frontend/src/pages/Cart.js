    ...
    <div className='container mx-auto'>
        ...
        <div className='flex flex-col lg:flex-row gap-10 lg:justify-between p-4'>   
                ...
                <div className='w-full max-w-3xl'>
                    {
                        loading ? (
                            loadingCart?.map((el,index) => {
                                return(
                                    <div key={el+"Add To Cart Loading"+index} className='w-full bg-white h-32 my-2 border border-slate-300 animate-pulse rounded'>
                                    </div>
                                )
                            })
                ...
                <div className='mt-5 lg:mt-0 w-full max-w-sm'>
                        {
                            loading ? (
                            <div className='h-36 bg-white border border-slate-300 animate-pulse'>
